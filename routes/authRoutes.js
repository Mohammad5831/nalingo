...
router.get('/profile/:userUUID', authController.getUserDetail);
...
router.put('/profile/:userUUID', updateUserValidation, handleValidationErrors, authController.updateUserDetail);
