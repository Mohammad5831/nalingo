...
router.get('/profile', authController.getUserDetail);
...
router.put('/profile/:userUUID', authMiddleware.verifyToken, updateUserValidation, handleValidationErrors, authController.updateUserDetail);
