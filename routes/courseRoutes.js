...
router.post('/', createCourseValidation, handleValidationErrors, authMiddleware.verifyToken, authMiddleware.IsAdminOrTeacher, uploadMiddleware.coursePreview.single('coursePreview'), courseController.createCourse);
// Edit course (course creator or admin only)
router.put('/:courseUUID', updateCourseValidation, handleValidationErrors, authMiddleware.verifyToken, authMiddleware.IsAdminOrTeacher, uploadMiddleware.coursePreview.single('coursePreview'), courseController.updateCourse);
