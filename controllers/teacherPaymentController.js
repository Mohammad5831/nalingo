...
const { createdTeacherPayment, createdTeacherPaymentItem, findAllPayments, getTeacherPaymentByPaymentUUID, paymentUploadProof, findAllPaymentsByTeacherID, } = require('../services/teacherPaymentService');
...
const createPayment = async (req, res) => {
    try {
        ...
        for (const course of courses) {
            ...
            const commissionPercent = course.commissionPercent || 20; // درصد پیش‌فرض
        ...
        res.status(201).json({ message: "پرداخت با موفقیت ایجاد شد", payment });
    } catch (err) {
...
// Receive all payments from a teacher
